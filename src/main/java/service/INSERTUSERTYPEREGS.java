...
/**
 * <p>Clase Java para INSERT_USER_TYPE_REGS complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="INSERT_USER_TYPE_REGS"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "INSERT_USER_TYPE_REGS", propOrder = {
    "arg0"
})
public class INSERTUSERTYPEREGS {
