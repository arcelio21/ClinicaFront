 ...
 * 
 */
@WebServiceClient(name = "TaddressServiceImplService", targetNamespace = "http://addressService.service.cliniacajavaee.com/", wsdlLocation = "http://192.168.137.1:7001/TaddressServiceImpl/TaddressServiceImplService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName TADDRESSSERVICEIMPLSERVICE_QNAME = new QName("http://addressService.service.cliniacajavaee.com/", "TaddressServiceImplService");
    ...
    public TaddressService getTaddressServiceImplPort() {
        return super.getPort(new QName("http://addressService.service.cliniacajavaee.com/", "TaddressServiceImplPort"), TaddressService.class);
    }
    ...
    public TaddressService getTaddressServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://addressService.service.cliniacajavaee.com/", "TaddressServiceImplPort"), TaddressService.class, features);
    }
